    ...
    var O = function () {
        ...
        a.prototype = {show: function () {
            ...
            var g = this, d = g.el, b = g.options, c = g.calendar, j = "gldp-" + b.cssName, t = b.todayDate._val(), u = t.time, h = b.borderSize + "px", y = function (b, m, a) {
                ...
                y = y(0, 6, b.selectableDOW), z = b.dowNames || "Mon Tue Wed Thu Fri Sat Sun".split(" "), t = b.monthNames || "Январь Февраль Март Апрель Май Июнь Июль Август Сентябрь Октябрь Ноябрь Декабрь".split(" "), f = d.outerWidth(), e, k = f / 7 + 6 * (b.borderSize / 7), f = f / 8 + 7 * (b.borderSize / 8);
            c.length ? eval(c.data("is")) || (f = c.outerWidth(), e = c.outerHeight(), k = f / 7 + 6 * (b.borderSize / 7), f = e / 8 + 7 * (b.borderSize / 8)) : (g.calendar = c = $("<div/>").attr("gldp-el", d.attr("gldp-id")).data("is", !0).css({display: b.showAlways ? void 0 : "none", zIndex: b.zIndex,
                width: 7 * k + "px"}), $("#mydate").parent().append(c));
            d.is(":visible") || c.hide();
            ...
            for (l = e = 0; 7 > e; e++)for (var q = 0; 7 > q; q++, l++) {
                ...
                if (e) {
                    ...
                    !s || 0 > v._indexOf(p.year) || 0 > H._indexOf(p.month) || 0 > y._indexOf(p.day) ? n = "noday" : (n = " mon tue wed thu fri sat sun".split(" ")[p.day], I != p.month && (n += " outday"), u == x && (n = "today", r += 50), b.selectedDate._time() == x && (n = "selected", r += 51), b.specialDates && $.each(b.specialDates, function (b, a) {
                        D(a, a.date).time ==
